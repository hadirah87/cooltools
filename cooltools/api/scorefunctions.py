...
####### peak score ###########
def peak_lowerLeft(peak_snippet, peak_length, background_length):
...
def peak_lowerRight(peak_snippet, peak_length, background_length):
    mid = len(peak_area) // 2
    return np.mean(
        peak_snippet[
            mid - peak_length : mid + peak_length, mid - peak_length : mid + peak_length
...
def peak_upperRight(peak_snippet, peak_length, background_length):
    mid = len(peak_snippet) // 2
    return np.mean(
        peak_snippet[
            mid - peak_length : mid + peak_length, mid - peak_length : mid + peak_length
...
def peak_upperLeft(peak_snippet, peak_length, background_length):
    mid = len(peak_snippet) // 2
    return np.mean(
        peak_snippet[
            mid - peak_length : mid + peak_length, mid - peak_length : mid + peak_length
...
def peak_score(peak_snippet, peak_length, background_length):
    avg = (
